...
// ============================================================================
// FC Layer:      0xC400_0000 - 0xC400_0008 (legacy non-buffered)
//                0xC470_xxxx (buffered mode)
// Conv Layer:    0xC400_000C - 0xC400_0014 (non-buffered FMA)
//                0xC410_xxxx (weight), 0xC420_xxxx (input), 0xC430_xxxx (output)
//                0xC460_xxxx (params)
// Pooling Layer: 0xC400_0018 - 0xC400_002C (legacy non-buffered)
//                0xC450_xxxx (buffered mode)
// Profiler:      0xC400_0030 - 0xC400_0040

wire fc_sel = ((addr_i[31:8] == 24'hC400_00) && (addr_i[7:0] <= 8'h08)) ||
              (addr_i[31:16] == 16'hC470);

wire pool_sel = ((addr_i[31:8] == 24'hC400_00) && 
                 ((addr_i[7:0] >= 8'h18) && (addr_i[7:0] <= 8'h2C))) ||
                (addr_i[31:16] == 16'hC450);

wire conv_sel = ((addr_i[31:8] == 24'hC400_00) && (addr_i[7:0] >= 8'h0C) && (addr_i[7:0] <= 8'h14)) ||
                (addr_i[31:16] == 16'hC410) ||
